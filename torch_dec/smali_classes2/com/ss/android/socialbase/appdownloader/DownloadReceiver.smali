...
# static fields
.field private static final d:Ljava/lang/String; = "DownloadReceiver"
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/ss/android/socialbase/appdownloader/DownloadReceiver;->j:Landroid/os/Handler;

    return-void
.end method

.method static synthetic d(Lcom/ss/android/socialbase/appdownloader/DownloadReceiver;)Landroid/os/Handler;
    .locals 0

    .line 36
    iget-object p0, p0, Lcom/ss/android/socialbase/appdownloader/DownloadReceiver;->j:Landroid/os/Handler;
...
.method private d(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 128
    invoke-static {}, Lcom/ss/android/socialbase/downloader/downloader/pl;->bg()Z
    ...
    invoke-static {v0, p1, p2, v1}, Lcom/ss/android/socialbase/downloader/downloader/pl;->d(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/Future;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 57
    sget-object p2, Lcom/ss/android/socialbase/appdownloader/DownloadReceiver;->d:Ljava/lang/String;

    const-string v1, "Received broadcast intent for android.intent.action.MEDIA_MOUNTED"

    invoke-static {p2, v1}, Lcom/ss/android/socialbase/downloader/pl/d;->d(Ljava/lang/String;Ljava/lang/String;)V

    .line 60
    :cond_2
    invoke-direct {p0, p1, v0}, Lcom/ss/android/socialbase/appdownloader/DownloadReceiver;->d(Landroid/content/Context;Ljava/lang/String;)V
