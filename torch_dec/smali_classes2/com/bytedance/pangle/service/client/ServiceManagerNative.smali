...
.method public bindServiceNative(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/lang/String;)Z
    ...
    invoke-static {p1}, Lcom/bytedance/pangle/servermanager/j;->d(Ljava/lang/String;)Lcom/bytedance/pangle/nc;

    move-result-object p1

    .line 105
    invoke-interface {p1}, Lcom/bytedance/pangle/nc;->asBinder()Landroid/os/IBinder;
    ...
    check-cast p3, Lcom/bytedance/pangle/m;

    invoke-interface {p1, p2, p3, p4, p5}, Lcom/bytedance/pangle/nc;->bindService(Landroid/content/Intent;Lcom/bytedance/pangle/m;ILjava/lang/String;)Z
...
.method public startServiceNative(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)Landroid/content/ComponentName;
    ...
    invoke-interface {p1, p2, p3}, Lcom/bytedance/pangle/nc;->startService(Landroid/content/Intent;Ljava/lang/String;)Landroid/content/ComponentName;
...
.method public stopServiceNative(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)Z
    ...
    invoke-interface {p1, p2, p3}, Lcom/bytedance/pangle/nc;->stopService(Landroid/content/Intent;Ljava/lang/String;)Z
...
.method public unbindServiceNative(Landroid/content/ServiceConnection;)V
    ...
    invoke-static {v1}, Lcom/bytedance/pangle/servermanager/j;->d(Ljava/lang/String;)Lcom/bytedance/pangle/nc;
    ...
    check-cast v2, Lcom/bytedance/pangle/m;

    invoke-interface {v1, v2}, Lcom/bytedance/pangle/nc;->unbindService(Lcom/bytedance/pangle/m;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
